...
For context and instructions for coding agents, see the project guidance at [TODO: replace with actual agents guidance URL] (current reference: https://agents.md). Capture any project-specific guidance here, including:
