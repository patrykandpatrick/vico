...
For context and instructions for coding agents, see the project guidance at [TODO: Add agents guidance URL] (for example, https://example.com/agents-guidance or an internal site such as https://agents.md). Capture any project-specific guidance here, including:
