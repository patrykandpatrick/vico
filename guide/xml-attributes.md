...
An extensive XML styling framework is available. See [`attrs.xml`](https://github.com/patrykandpatrick/vico/blob/views/vico/views/src/main/res/values/attrs.xml) for an attribute list.
