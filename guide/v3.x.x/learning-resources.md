...
Follow the links above to view the code on GitHub. For Android, you can also [download the APK](https://github.com/patrykandpatrick/vico/releases/download/v3.0.1/android-sample-debug.apk). To work with the sample app locally, clone the repository, switch to the right tag, open the project in Android Studio, and navigate to the [`sample`](https://github.com/patrykandpatrick/vico/tree/stable/sample) module.
