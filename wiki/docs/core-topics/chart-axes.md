...
- In the view system, axes can be added to charts via [XML attributes](https://github.com/patrykandpatryk/vico/wiki/Customization-in-the-view-system) or programmatically (in which case we recommend using the `create*Axis` builder functions).
...
- In the view system, axes can be customized via [XML attributes](https://github.com/patrykandpatryk/vico/wiki/Customization-in-the-view-system) or programmatically.
