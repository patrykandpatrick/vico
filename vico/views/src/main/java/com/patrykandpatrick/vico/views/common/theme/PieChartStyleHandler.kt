...
import com.patrykandpatrick.vico.core.common.DefaultDimens.SLICE_ANGLED_SEGMENT_LENGTH
import com.patrykandpatrick.vico.core.common.DefaultDimens.SLICE_HORIZONTAL_SEGMENT_LENGTH
import com.patrykandpatrick.vico.core.common.DefaultDimens.SLICE_OUTSIDE_LABEL_MAX_WIDTH_TO_BOUNDS_RATIO
...
import com.patrykandpatrick.vico.views.pie.insideLabel
import com.patrykandpatrick.vico.views.pie.outsideLabel
...
internal class PieChartStyleHandler(
    ...
    private fun TypedArray.getSliceLabel(
        ...
        return when (type) {
            SLICE_LABEL_TYPE_INSIDE -> SliceLabel.insideLabel(textComponent = textComponent)
            SLICE_LABEL_TYPE_OUTSIDE ->
                SliceLabel.outsideLabel(
