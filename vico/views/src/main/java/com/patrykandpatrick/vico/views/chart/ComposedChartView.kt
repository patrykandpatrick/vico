...
/**
 * A subclass of [BaseCartesianChartView] that displays charts that use [ComposedChartEntryModel].
 */
public class ComposedChartView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : BaseCartesianChartView<ComposedChartEntryModel<ChartEntryModel>>(
    context = context,
    attrs = attrs,
