...
import com.patrykandpatrick.vico.views.cartesian.axis.AxisManager
...
private constructor(
  ...
  internal val layerBounds: RectF = RectF()
  ...
  internal fun draw(context: CartesianDrawingContext, offset: Offset = Offset.Zero) {
    with(context) {
