...
import com.patrykandpatrick.vico.views.common.Defaults.AXIS_LABEL_HORIZONTAL_PADDING
import com.patrykandpatrick.vico.views.common.Defaults.AXIS_LABEL_VERTICAL_PADDING
import com.patrykandpatrick.vico.views.common.Defaults.TEXT_COMPONENT_LINE_COUNT
import com.patrykandpatrick.vico.views.common.Defaults.TEXT_COMPONENT_TEXT_SIZE
...
import com.patrykandpatrick.vico.views.common.firstNonNegativeOf
...
private fun TypedArray.getPadding(context: Context): Insets {
...
private fun TypedArray.getMargins(context: Context): Insets {
  fun getDpDimension(@StyleableRes index: Int): Float = getRawDimension(context, index, -1f)
