...
import com.patrykandpatrick.vico.views.cartesian.CartesianChart.PersistentMarkerScope
...
class CartesianChartTest {
  ...
  @Test
  fun `The exact order of persistent markers is preserved when set to CartesianChart`() {
