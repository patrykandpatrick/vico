...
private fun rememberDefaultColumnProvider(): ColumnCartesianLayer.ColumnProvider {
    ...
    return remember(columns) { ColumnCartesianLayer.ColumnProvider.series(columns) }
}

/** Creates and remembers a [ColumnCartesianLayer]. */
@Composable
public fun rememberColumnCartesianLayer(
    columnProvider: ColumnCartesianLayer.ColumnProvider = rememberDefaultColumnProvider(),
...
public fun rememberColumnCartesianLayer(
    ...
    rememberColumnCartesianLayer(
        remember(columns) { ColumnCartesianLayer.ColumnProvider.series(columns) },
        spacing,
        innerSpacing,
        mergeMode,
