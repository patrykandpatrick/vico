...
package com.patrykandpatrick.vico.compose.common.style
...
public data class ChartStyle(
     ...
     * respective columns.
     * @property dataLabelValueFormatter the [CartesianValueFormatter] to use for data labels.
    ...
    public data class ColumnLayer(
        ...
        val dataLabelValueFormatter: CartesianValueFormatter = DecimalFormatValueFormatter(),
