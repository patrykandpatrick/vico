...
public fun rememberLineComponent(
  ...
  remember(fill, shape, thickness, margins, strokeColor, strokeThickness, shadow) {
    LineComponent(
      fill,
      thickness.value,
      shape,
...
public fun shapeComponent(
  ...
  ShapeComponent(fill, shape, margins, strokeColor.toArgb(), strokeThickness.value, shadow)
...
public fun rememberShapeComponent(
  ...
  remember(fill, shape, margins, strokeColor, strokeThickness, shadow) {
    shapeComponent(fill, shape, margins, strokeColor, strokeThickness, shadow)
  }
