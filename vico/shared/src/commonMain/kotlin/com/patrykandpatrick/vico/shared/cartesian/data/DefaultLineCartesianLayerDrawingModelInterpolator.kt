...
internal class DefaultLineCartesianLayerDrawingModelInterpolator :
    ...
    delegate.setModels(
      old =
        if (old == null && new != null)
          LineCartesianLayerDrawingModel(
            new.map { series -> series.mapValues { LineCartesianLayerDrawingModel.Entry(0f) } },
            new.seriesKeys,
            opacity = 0f,
            revealFraction = 1f,
          )
  ...
  override fun equals(other: Any?): Boolean =
    this === other || other is DefaultLineCartesianLayerDrawingModelInterpolator
