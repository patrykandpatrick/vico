...
public sealed class AxisPosition {
  ...
  /**
   * Whether the axis is on the left of its [CartesianChart]. The layout direction is considered
   * here.
   */
  ...
  /**
   * Whether the axis is on the right of its [CartesianChart]. The layout direction is considered
   * here.
   */
