...
/**
 * Determines for what values a [HorizontalAxis] or a [VerticalAxis] is to display labels, ticks,
 * and guidelines.
 */
public interface AxisItemPlacer {
  ...
  public interface Horizontal : AxisItemPlacer {
    /**
     * Whether ticks whose _x_ values are bounds of the _x_-axis value range should be shifted to
     * the edges of the axis bounds, to be aligned with the vertical axes.
     */
    ...
    public companion object {
      /**
       * Creates a base [AxisItemPlacer.Horizontal] implementation. [spacing] defines how often
       * items should be drawn (relative to [ChartValues.xStep]). [offset] is the number of labels
       * (and, for [HorizontalLayout.FullWidth], their corresponding ticks and guidelines) to skip
       * from the start. [shiftExtremeTicks] defines whether ticks whose _x_ values are bounds of
       * the _x_-axis value range should be shifted to the edges of the axis bounds, to be aligned
       * with the vertical axes. [addExtremeLabelPadding] specifies whether, for
  ...
  public interface Vertical {
     ...
     * [CartesianChart]’s bounds. If the chart has a top axis, the shifted tick will then be aligned
     * with this axis, and the shifted guideline will be hidden.
     */
    ...
    public companion object {
      /**
       * Creates a step-based [AxisItemPlacer.Vertical] implementation. [step] returns the
       * difference between the _y_ values of neighboring labels (and their corresponding line
       * pairs). A multiple of this may be used for overlap prevention. If `null` is returned, the
       * step will be determined automatically. [shiftTopLines] defines whether to shift the lines
       * whose _y_ values are equal to [ChartValues.YRange.maxY], if such lines are present, such
       * that they’re immediately above the [CartesianChart]’s bounds. If the chart has a top axis,
       * the shifted tick will then be aligned with this axis, and the shifted guideline will be
       * hidden.
       */
      public fun step(
      ...
      /**
       * Creates a count-based [AxisItemPlacer.Vertical] implementation. [count] returns the number
       * of labels (and their corresponding line pairs) to be displayed. This may be reduced for
       * overlap prevention. If `null` is returned, the [VerticalAxis] will display as many items as
