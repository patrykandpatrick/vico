...
/**
 * A [CartesianValueFormatter] implementation that formats values using a [DecimalFormat] with a given pattern.
 */
public open class DecimalFormatValueFormatter(private val decimalFormat: DecimalFormat) : CartesianValueFormatter {
    /**
