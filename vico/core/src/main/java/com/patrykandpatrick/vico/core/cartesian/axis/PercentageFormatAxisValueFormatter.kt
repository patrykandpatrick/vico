...
import com.patrykandpatrick.vico.core.cartesian.formatter.PercentageFormatValueFormatter
 ...
 */
public class PercentageFormatAxisValueFormatter<Position : AxisPosition.Vertical>(pattern: String = DEF_PATTERN) :
